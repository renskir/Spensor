from tensorflow.keras.layers import Dense, Conv2D, Input, Flatten, MaxPool2D
from tensorflow.keras.models import Sequential


def create_model(input_shape, ouput_shape, conv_layers=1, dense_layers=1):
    model = Sequential()
    model.add(MaxPool2D((5, 5), input_shape=input_shape))
    model.add(Conv2D(10, kernel_size=(5, 5), strides=(3, 3), activation='relu'))
